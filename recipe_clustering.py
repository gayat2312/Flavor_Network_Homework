...
# Interactive plot with Bokeh; set up for four categories, with color palette; pass in df for either ingredient or flavor
...
if __name__ == '__main__':
    ...
    # Select four cuisines and plot t-SNE clustering with ingredients
    ...
    # Select four cuisines and plot t-SNE clustering with flavor
