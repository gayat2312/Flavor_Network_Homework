...
if __name__ == '__main__':
    # Load dataset for cuisines
    yum_cuisine = pd.read_pickle('data/yum_tfidf.pkl')

    # Prepare the data for clustering
    X_pca, labels_index = prepare_data_for_clustering(yum_cuisine)
